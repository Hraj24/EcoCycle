...
const ContactUs = () => {
  ...
  return (
    <>
    <Head>
     <title>EcoCycle - Connect With Our Sustainability Experts</title>
              ...
              <li className="footer-item flex items-start">
                ...
                <div>
                  ...
                  <address className="contact-link address text-gray-600">
                    Main Office: Greater Noida,<br />Uttar Pradesh, India 203201
                  </address>
                </div>
              </li>
              <li className="footer-item flex items-start">
              ...
              <li className="footer-item flex items-start">
                ...
                <div>
                  ...
                  <Link
                    target="_blank"
                    rel="noopener noreferrer"
                    href="mailto:contact@ecocycle.com"
                    className="contact-link text-gray-600 hover:text-emerald-500 transition-colors duration-300"
                  >
                ...
                <ul className="social-list mb-4 md:mb-0 flex justify-center space-x-4">
                  ...
                  <li>
                    <Link
                      ...
                      rel="noopener noreferrer"
                      href="/"
                      aria-label="Follow EcoCycle on Instagram"
                      className="social-link bg-gray-100 hover:bg-emerald-100 transition-colors duration-300"
                    >
                  ...
                  <li>
                    <Link
                      ...
                      rel="noopener noreferrer"
                      href="/"
                      aria-label="Follow EcoCycle on Twitter"
                      className="social-link bg-gray-100 hover:bg-emerald-100 transition-colors duration-300"
                    >
                  ...
                  <li>
                    <Link
                      ...
                      rel="noopener noreferrer"
                      href="/"
                      aria-label="Contact EcoCycle on WhatsApp"
                      className="social-link bg-gray-100 hover:bg-emerald-100 transition-colors duration-300"
                    >
