      ...
      <div className="container mx-auto px-4">
        <div className="hero-content text-center">
          <p className="mb-4 hero-subtitle has-before">
            Welcome to EcoCycle — Powering a Greener Tomorrow
          </p>
          ...
          <p className="text-gray-700 mb-8 text-center md:text-start">
            EcoCycle: Revolutionizing E-Waste Management for a Sustainable Future. Discover nearby e-waste facilities with precision and ease.
