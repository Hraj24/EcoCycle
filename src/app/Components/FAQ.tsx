...
const FAQ = () => {
    const faqData = [
        {
          question: "How does EcoCycle help me find e-waste recycling facilities?",
          answer:
            "EcoCycle's intelligent facility locator uses geolocation technology to instantly identify certified e-waste recycling centers nearest to you. Simply access our interactive map interface, enter your location, and discover detailed information about each facility including operational hours, accepted materials, certification status, and user ratings—all designed to make responsible e-waste disposal effortless and convenient.",
        },
        {
          question: "How does EcoCycle verify the facilities listed on the platform?",
          answer:
        ...
        {
          question: "Can I schedule the pickup and recycling of my e-waste through EcoCycle?",
          answer:
        ...
        {
          question: "What kind of educational resources does EcoCycle offer?",
          answer:
        ...
        {
          question: "What additional benefits do I get by subscribing to the EcoCycle newsletter?",
          answer:
