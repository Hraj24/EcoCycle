...
const Recycle: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>EcoCycle - Electronics Recycling Solutions</title>
        <meta name="description" content="Responsibly recycle your electronic devices with EcoCycle's specialized recycling programs for smartphones, laptops, TVs, refrigerators and more." />
      </Head>
      ...
      <div className="section container mx-auto px-4 recycle-container">
        ...
        <div className="mt-20 bg-emerald-50 rounded-lg p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-emerald-700">Why Recycle Electronics With EcoCycle?</h3>
