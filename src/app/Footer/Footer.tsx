    ...
    <footer className="footer projects shadow-2xl">
        ...
        <div className="container">
          <div className="footer-brand">
            <Link href="/">
              <Image
                src={logo}
                alt="EcoCycle - E-waste Facility Locator"
                width={100}
                height={100}
            ...
            <p className="footer-text">
              EcoCycle: Revolutionizing e-waste management through technological innovation. Our platform connects you with certified recycling facilities, empowering your journey toward environmental responsibility and sustainable electronics disposal.
            </p>
          ...
          <ul className="footer-list">
            <li>
              <p className="footer-list-title">EcoCycle Platform</p>
            </li>
            <li>
          ...
          <ul className="footer-list">
            ...
            <li className="footer-item">
              ...
              <address className="contact-link address">
                Greater Noida,<br />Uttar Pradesh, India 203201
              </address>
            </li>
            <li className="footer-item">
      ...
      <div className="footer-bottom">
        ...
        <p className="copyright">
            &copy; 2025 EcoCycle | All Rights Reserved by{" "}
